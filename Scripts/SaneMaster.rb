...
# ==============================================================================
# SaneMaster: Professional Automation Suite for SaneSync
# ==============================================================================
...
class SaneMaster
  ...
  def initialize
    @bundle_id = 'com.sanevideo.SaneSync'
  end
  ...
  def check_binary
    ...
    build_settings = `xcodebuild -scheme SaneSync -showBuildSettings 2>/dev/null`
